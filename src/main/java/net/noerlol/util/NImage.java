...
public class NImage extends BufferedImage {
    /**
     ...
     */
    public NImage(int width, int height, int imageType) {
     ...
     * @see #TYPE_BYTE_INDEXED
     */
    public NImage(int width, int height, int imageType, IndexColorModel cm) {
     ...
     * @see WritableRaster
     */
    public NImage(ColorModel cm, WritableRaster raster, boolean isRasterPremultiplied, Hashtable<?, ?> properties) {
        super(cm, raster, isRasterPremultiplied, properties);
    }

    public NImage resize(Dimension newDimensions) {
        Image resizedImage = this.getScaledInstance(newDimensions.width, newDimensions.height, Image.SCALE_SMOOTH);
        NImage bufferedImage = new NImage(newDimensions.width, newDimensions.height, BufferedImage.TYPE_INT_ARGB);
